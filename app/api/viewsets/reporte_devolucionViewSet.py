...
class Reporte_DevolucionViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            Reporte_Devolucion = serializer.save()
            

            return Response(self.get_serializer(Reporte_Devolucion).data, status=status.HTTP_201_CREATED)
    ...
    def destroy(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": f"Rerporte de devolucion con id {kwargs['pk']} eliminado"},
