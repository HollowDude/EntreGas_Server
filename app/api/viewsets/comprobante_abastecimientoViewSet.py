...
class Comprobante_AbastecimientoViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            Comprobante_Abastecimiento = serializer.save()
            

            return Response(self.get_serializer(Comprobante_Abastecimiento).data, status=status.HTTP_201_CREATED)
    ...
    def destroy(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": f"Comprobante Abastecimiento con id {kwargs['pk']} eliminado"},
